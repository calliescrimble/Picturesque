...
public class AspenLeavesBlock extends TintedParticleLeavesBlock {
    public AspenLeavesBlock(float leafParticleChance, Properties settings) {
        super(leafParticleChance, settings);
    }

    @Override
    protected void spawnFallingLeavesParticle(Level world, BlockPos pos, RandomSource random) {
        ColorParticleOption tintedParticleEffect = ColorParticleOption.create(ParticleTypes.TINTED_LEAVES, 0xFFD561);
