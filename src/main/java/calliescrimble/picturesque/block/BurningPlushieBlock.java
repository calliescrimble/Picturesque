...
public class BurningPlushieBlock extends HorizontalFacingBlock {
    public static final MapCodec<BurningPlushieBlock> CODEC = createCodec(BurningPlushieBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(3.0, 0.0, 3.0, 13.0, 16.0, 13.0);

    public BurningPlushieBlock(Settings settings) {
        super(settings);
    }
