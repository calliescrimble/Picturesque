...
public class CynthiaPlushieBlock extends HorizontalFacingBlock {
    public static final MapCodec<CynthiaPlushieBlock> CODEC = createCodec(CynthiaPlushieBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(3.0, 0.0, 3.0, 13.0, 16.0, 13.0);

    public CynthiaPlushieBlock(Settings settings) {super(settings);}
