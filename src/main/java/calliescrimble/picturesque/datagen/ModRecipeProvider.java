    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider wrapperLookup, RecipeOutput recipeExporter) {
        return new RecipeProvider(wrapperLookup, recipeExporter) {
            ...
            public void buildRecipes() {
                ...
                stonecutterResultFromBase(RecipeCategory.MISC, ModBlocks.CALLIE_PLUSHIE, Blocks.WOOL.gray());
                stonecutterResultFromBase(RecipeCategory.MISC, ModBlocks.CYNTHIA_PLUSHIE, Blocks.WOOL.yellow());
                ...
                shapeless(RecipeCategory.MISC, Items.DYE.magenta())
                        ...
                        .save(output);
                shapeless(RecipeCategory.MISC, Items.DYE.white())
                ...
                shaped(RecipeCategory.MISC, ModBlocks.ASPEN_SIGN, 3)
                        ...
                        .unlockedBy(getHasName(ModBlocks.ASPEN_PLANKS), has(ModBlocks.ASPEN_PLANKS))
                        .save(output);
                shaped(RecipeCategory.MISC, ModBlocks.ASPEN_HANGING_SIGN, 6)
                        .pattern("I I")
                        .pattern("AAA")
                        .pattern("AAA")
                        .define('A', ModBlocks.STRIPPED_ASPEN_LOG)
